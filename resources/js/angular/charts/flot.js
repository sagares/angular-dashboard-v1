					...
					return {
						...
						link : function(scope, element) {
							...
							var options = {
								series : {
									shadowSize : 0,
									curvedLines : { // This is a third party
													// plugin to make curved
													// lines
										apply : true,
										active : true,
										monotonicFit : true
				...
				function() {
					return {
						...
						link : function(scope, element, attrs) {
							var data1 = [ [ 1, 60 ], [ 2, 30 ], [ 3, 50 ],
									[ 4, 100 ], [ 5, 10 ], [ 6, 90 ], [ 7, 85 ] ];
							var data2 = [ [ 1, 20 ], [ 2, 90 ], [ 3, 60 ],
									[ 4, 40 ], [ 5, 100 ], [ 6, 25 ], [ 7, 65 ] ];
					...
					return {
						...
						link : function(scope, element, attrs) {
							...
							function update() {
								...
								// Since the axes don't change, we don't need to
								// call plot.setupGrid()
